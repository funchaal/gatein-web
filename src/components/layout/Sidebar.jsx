    ...
    >
      ...
      <div className="flex mb-7 items-center justify-between pl-6 pr-3.5 flex-shrink-0">
        <div className="flex items-center gap-2.5">
          <img src="/icon.png" alt="GateIn" className="w-7 h-7 rounded-lg object-cover" />
          <span className="font-bold text-[22px] text-gray-900 dark:text-white tracking-tight">GateIn</span>
        </div>
        <button
