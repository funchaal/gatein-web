...
export function CardHeaderElement({ header, subHeader, data, status, statusColor }) {
  const styles = {
    ...
    label: { fontSize: 14, color: THEME.slate400, fontWeight: 500, marginBottom: 2 },
    ...
    subLabel: { fontSize: 14, color: THEME.slate400, fontWeight: 500, marginBottom: 2 },
...
export function CardRowElement({ row, data }) {
  const styles = {
    ...
    label: { fontSize: 14, color: THEME.slate400, fontWeight: 500 },
