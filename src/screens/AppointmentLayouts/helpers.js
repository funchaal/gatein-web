...
export function defaultState() {
  return {
    ...
    modal_layout: [
      { id: uid(), element: "section", title: "Detalhes da Operação" },
      { id: uid(), element: "field", label: "Resumo", field: "summary" },
      { id: uid(), element: "field", label: "Nota Fiscal", field: "nota_fiscal" },
      { id: uid(), element: "field", label: "CNH", field: "cnh_motorista" },
