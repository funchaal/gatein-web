import { Lock, AlertCircle, CheckCircle2, Copy, Terminal, Clock, FlaskConical } from 'lucide-react';
import { Button } from '@/components/ui/button';

export default function StagingPasswordModal({
  showModal,
  generatedPassword,
  copied,
  handleCopy,
  ...
  if (!showModal || !generatedPassword) return null;
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
      <div className="bg-white dark:bg-[#0D0D0D] rounded-2xl border border-gray-200 dark:border-[#262626] w-full max-w-2xl overflow-hidden">
        ...
        <div className="flex items-center gap-3 px-6 py-5 border-b border-gray-100 dark:border-[#262626]">
          ...
          <div>
            <h2 className="text-base font-semibold text-gray-900 dark:text-gray-100">Nova senha de homologação gerada</h2>
        ...
        <div className="p-6 space-y-5">
          ...
          <div className="flex items-start gap-3 p-4 border border-gray-200 dark:border-none rounded-xl bg-gray-50 dark:bg-gray-900">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400">
              Esta é a única vez que a senha completa será exibida. Ela não poderá ser recuperada depois. Copie e compartilhe com a equipe de testes.
            </p>
          </div>

          {/* Password display */}
          <div className="space-y-2">
            <p className="text-xs font-medium text-gray-500 dark:text-gray-400">Sua senha de homologação</p>
          ...
          <div className="flex items-start gap-3 p-4 border border-gray-200 dark:border-[#262626] rounded-xl">
            ...
            <div>
              ...
              <ol className="text-sm text-gray-500 dark:text-gray-400 space-y-1.5 list-decimal list-inside">
                <li>Acesse o aplicativo mobile no ambiente de homologação</li>
                <li>Utilize o CPF do motorista cadastrado junto a esta senha mestra</li>
